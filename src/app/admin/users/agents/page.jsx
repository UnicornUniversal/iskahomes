...
import { FiSearch, FiFilter, FiUsers, FiEye, FiEdit, FiTrash2, FiCheckCircle, FiXCircle, FiStar } from 'react-icons/fi'
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage and monitor real estate agents on your platform.</p>
      </div>
