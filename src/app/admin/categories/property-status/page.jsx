...
import { FiSearch, FiPlus, FiEdit, FiTrash2, FiCheckCircle, FiCheckCircle as FiActive, FiRefreshCw } from 'react-icons/fi'
...
const PropertyStatusPage = () => {
  ...
  const handleReconcile = async () => {
    setReconciling(true)
    try {
      const response = await fetch('/api/admin/property-statuses?reconcile=true')
      const result = await response.json()
