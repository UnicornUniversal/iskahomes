...
const DataCard = ({ title, value, link, linkText, icon: Icon }) => {
  return (
    <div className=' design1 relative border-[#E0B29A]  p-6 shadow-sm w-full'>
      <div className='flex items-center gap-3 mb-4'>
        <div className='w-7 h-7  absolute top-3 right-3 rounded-full border-2 border-[#17637C] flex items-center justify-center'>
