...
const SearchGeneral = () => {
  ...
  <div className="flex items-center bg-[#f8f8f8] p-[1em] rounded-md w-full  mx-auto">
      {/* Dropdown */}
      <select className="bg-white px-3 py-2 rounded-md text-[#19505b] font-medium mr-2 text-sm min-w-[110px] focus:outline-none">
        <option>Rent</option>
        <option>Buy</option>
        <option>Lease</option>
      ...
      />
      {/* Search Button */}
      <button className="bg-orange-500 hover:bg-orange-600 p-3 rounded-md flex items-center justify-center">
