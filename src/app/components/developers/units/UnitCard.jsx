  ...
  return (
    ...
    >
        ...
        {coverImage ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
            <div className="text-center text-primary_color">
              ...
              <p className="text-sm text-primary_color">No Image</p>
            </div>
          </div>
        )}
      ...
      <div className="p-4">
        {/* Unit Title */}
        <div className="mb-3">
          <h3 className="font-semibold text-lg text-primary_color">{unit.title}</h3>
        </div>

        {/* Location Info */}
        <div className="mb-2">
          <div className="flex items-center text-sm text-primary_color mb-1">
        ...
        <div className="mb-3">
          <p className="text-2xl font-bold text-primary_color">
            ...
            <span className="text-sm font-normal text-primary_color ml-1">
              {(unit.pricing?.price_type || unit.price_type) === 'rent' 
