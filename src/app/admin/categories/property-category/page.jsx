...
import { FiPlus, FiEdit2, FiTrash2, FiSave, FiX, FiGrid, FiRefreshCw } from 'react-icons/fi'
...
const PropertyCategoriesPage = () => {
  ...
  const handleReconcile = async () => {
    setReconciling(true)
    try {
      const response = await fetch('/api/admin/property-categories?reconcile=true')
      const result = await response.json()
