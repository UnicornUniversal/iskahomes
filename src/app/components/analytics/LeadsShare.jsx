...
export default function LeadsShare({ totalLeadsData }) {
  ...
  const whatsappLeads = messagingData?.whatsapp?.total ?? leadsBreakdown?.whatsapp?.total ?? totalLeadsData?.whatsapp_leads ?? 0
  const directMessageLeads = messagingData?.direct_message?.total ?? leadsBreakdown?.direct_message?.total ?? totalLeadsData?.direct_message_leads ?? 0
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
      <div className="default_bg rounded-lg shadow p-4 text-center">
