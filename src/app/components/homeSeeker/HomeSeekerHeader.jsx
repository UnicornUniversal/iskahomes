...
const HomeSeekerHeader = () => {
  ...
  return (
    <div className='w-full bg-white/30 p-4 sm:p-6 lg:p-8 rounded-2xl border border-primary_color/10 shadow-lg mb-6'>
      <div className='flex items-center gap-3'>
        ...
        <div>
          ...
          <h1 className=' text-primary_color font-medium mb-1'>
