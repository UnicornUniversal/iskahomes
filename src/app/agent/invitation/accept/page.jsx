...
const AcceptInvitationContent = () => {
  ...
  useEffect(() => {
    const verifyToken = async () => {
      ...
      try {
        const response = await fetch(`/api/agencies/agents/invite/accept?token=${token}`)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/agencies/agents/invite/accept', {
        method: 'POST',
        headers: {
      ...
      if (response.ok && result.success) {
        ...
        if (result.data?.email_confirmation_required) {
          ...
          // Redirect to sign-in after 3 seconds only if email is confirmed
          setTimeout(() => {
              ...
              <>
                <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800 mb-3">
                    We've sent a confirmation email to <strong>{agentData?.email}</strong>. 
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <button
                    onClick={() => {
                      ...
                      toast.info('If you didn\'t receive the email, please check your spam folder or contact support.', {
                        position: "top-center",
                        autoClose: 4000,
                      })
                    }}
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-600">
              {agentData && (
                <>
                  You've been invited to join <strong>{agentData.agency_name}</strong> as an agent.
                  <br />
